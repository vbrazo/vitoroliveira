...
const services = [
  {
    ...
    icon: <Users className="h-8 w-8 text-cto-blue" />
  },
  {
    id: 2,
    ...
    icon: <BarChart className="h-8 w-8 text-cto-blue" />
  },
  {
    id: 3,
    ...
    icon: <Shield className="h-8 w-8 text-cto-blue" />
  },
  {
    id: 4,
    ...
    icon: <FileText className="h-8 w-8 text-cto-blue" />
  }
];
